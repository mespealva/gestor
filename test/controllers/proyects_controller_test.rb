...
class ProyectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post proyects_url, params: { proyect: { desc: @proyect.desc, estado: @proyect.estado, fecha_inicio: @proyect.fecha_inicio, fecha_termino: @proyect.fecha_termino, nombre: @proyect.nombre } }
    end
  ...
  test "should update proyect" do
    patch proyect_url(@proyect), params: { proyect: { desc: @proyect.desc, estado: @proyect.estado, fecha_inicio: @proyect.fecha_inicio, fecha_termino: @proyect.fecha_termino, nombre: @proyect.nombre } }
